...
<body>
	...
	<form:form action="${actionURL}" modelAttribute="emp">
		<table border="1">
			<tr>
				<th>EMPLOYEE_ID</th>
				<td><form:input path="employeeId" /> <form:errors path="employeeId" class="error" /></td>
			</tr>
			<tr>
				<th>FIRST_NAME</th>
			...
			<tr>
				<th>PHONE_NUMBER</th>
				<td><form:input path="phoneNumber" /> <form:errors path="phoneNumber" class="error" /></td>
			</tr>
			<tr>
				<th>HIRE_DATE</th>
			...
			<tr>
				<th>SALARY</th>
				<td><form:input path="salary" type="number" /> <form:errors path="salary" class="error" /></td>
			</tr>
			<tr>
				<th>COMMISSION_PCT</th>
				<td><form:input path="commissionPct" type="number" step="any" /> <form:errors path="commissionPct" class="error" /></td>
			</tr>
			<tr>
				<th>MANAGER_ID</th>
